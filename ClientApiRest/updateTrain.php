...
<body>
    ...
    <div class="container">
        ...
        <form action="index" id="myform" method="post">
            <input type="hidden" class="form-control" name="numTrain" id="numTrain" value="<?php echo $_GET["id"] ?>">
            ...
            <button type="submit" class="btn btn-primary" onclick="updateTrain()">Submit</button>
        </form>
    </div>
    <!-- Optional JavaScript -->
